...
@then(u'an error message "The two password fields didn’t match." is issued')
def step_impl(context):
    pass
    # raise NotImplementedError(u'STEP: Then an error message "The two password fields didn’t match." is issued')